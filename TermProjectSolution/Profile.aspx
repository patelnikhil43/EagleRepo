...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div id="UserProfileImageDiv">
            ...
            <asp:Button Text="Upload" CssClass="btnFB2" ID="ChangeUserProfileImageButton" runat="server" OnClick="ChangeUserProfileImageButton_Click" />
        </div>
        <div id="UserProfileInformation" style="text-align: center;">
            <asp:Table ID="UserProfileTable" runat="server">
            </asp:Table>
            <asp:Button Text="Update Profile" CssClass="btnFB2" ID="btnUpdateProfile" runat="server" OnClick="btnUpdateProfile_Click" />
        </div>
        <br />
        <div>
            <div id="FriendListDiv" class="threediv">
                <asp:GridView ID="FriendListGV" CssClass="gvFB" runat="server" AutoGenerateColumns="False" OnRowCommand="FriendListGV_RowCommand" HorizontalAlign="Center">
                    <Columns>
                        <%--  <asp:TemplateField>
                        <ItemTemplate>
            ...
            <div id="postContainer" class="threediv">
                <h4>Post Content</h4>
                <br />
                <asp:DropDownList ID="ChoosePostTypeDD" ForeColor="Black" AutoPostBack="true" runat="server" OnSelectedIndexChanged="ChoosePostTypeDD_SelectedIndexChanged">
                ...
                <div id="TypeImagePostDiv" runat="server" visible="false">
                    ...
                    <asp:GridView runat="server" CssClass="gvFB" AutoGenerateColumns="false" ID="TagFriendsGV" HorizontalAlign="Center">
                        <Columns>
                ...
                <asp:Button Text="Post" CssClass="btnFB2" ID="PostButton" runat="server" OnClick="PostButton_Click" />
            </div>

            <div id="photoUploadContainer" class="threediv">
                <h4>Photo Gallery</h4>
                ...
                <br />
                <asp:Button Text="Save" CssClass="btnFB2" ID="UploadImageGalleryButton" runat="server" OnClick="UploadImageGalleryButton_Click" />

                <br />
                <asp:Label ID="NoImagesLabel" Text="Sorry! No Images Available. Upload some!" runat="server" Visible="false" />
                <div style="text-align: center;">
                    <asp:GridView runat="server" CssClass="gvFB" ID="ImageGalleryGV" AutoGenerateColumns="False" OnRowCommand="ImageGalleryGV_RowCommand">
                        <Columns>
